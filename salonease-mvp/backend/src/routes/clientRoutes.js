...
const searchValidationMiddleware = require('../middleware/searchValidationMiddleware');
const ROLES = require('../config/roles');

router.use(authMiddleware);
router.use(roleMiddleware([ROLES.SALON_OWNER, ROLES.STAFF]));

router.get('/:salonId', searchValidationMiddleware, clientController.getClients);
