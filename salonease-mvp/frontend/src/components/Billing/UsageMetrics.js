    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <FaFileInvoice className="text-gray-400 h-6 w-6" />
        </div>
        <p className="text-gray-500">{t('billing:usage.no_data')}</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-gray-500">{t('billing:usage.billing_period')}</span>
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-900">{t('billing:usage.usage_details')}</h3>
          {invoice.lines.data.map((line) => (
            <div key={line.id} className="border-b pb-4">
        ...
        <div className="space-y-2 pt-4 border-t">
          <div className="flex justify-between text-sm">
            <span className="text-gray-500">{t('billing:usage.subtotal')}</span>
            <span className="text-gray-900">
          ...
          {invoice.tax > 0 && (
            <div className="flex justify-between text-sm">
              <span className="text-gray-500">{t('billing:usage.tax')}</span>
              <span className="text-gray-900">
